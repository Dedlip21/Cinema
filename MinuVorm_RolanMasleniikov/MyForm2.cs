...
namespace MinuVorm_RolanMasleniikov
{
    public partial class MyForm2 : Form
    {
        ...
        public MyForm2()
        { }
        public MyForm2(string title, string body, string button1, string button2, string button3, string button4)
        {
            texts[0] = button1;
            texts[1] = button2;
            texts[2] = button3;
        ...
        public MyForm2(string title, string body, string button1, string button2)
        {
            texts[0] = button1;
            texts[1] = button2;
        ...
        public MyForm2(int read, int kohad)
        {
